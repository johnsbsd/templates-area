...
echo "/dev/iso9660/${ZBSD_LABEL} / cd9660 rw 0 0" > ${CLONEDIR}/etc/fstab
...
mkisofs -hfs-bless boot -map ${SRCDIR}/release/powerpc/hfs.map -r -hfs -part -no-desktop -hfs-volid ${ZBSD_LABEL} -V ${ZBSD_LABEL} -l -J -L -o $ISOPATH . >> ${LOGFILE} 2>&1
